...
# author: 'Chun Man, LEE ; ID: 04264226'
# date: "6/3/2020"

# first load up the data
train <- read.csv(file = 'c:/Users/Vincent Lee/Desktop/MFIT5010/Project/train.csv')
test <- read.csv(file = 'c:/Users/Vincent Lee/Desktop/MFIT5010/Project/test.csv')
songs <- read.csv(file = 'c:/Users/Vincent Lee/Desktop/MFIT5010/Project/songs.csv')
members <- read.csv(file = 'c:/Users/Vincent Lee/Desktop/MFIT5010/Project/members.csv')
